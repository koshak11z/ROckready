package im.zov4ik.common.repository.staff;

import im.zov4ik.zov4ik;
import im.zov4ik.utils.client.managers.file.FileController;
import im.zov4ik.utils.client.managers.file.impl.StaffFile;
...
public class StaffRepository {
    ...
    private static void save() {
        FileController fileController = zov4ik.getInstance().getFileController();
