package im.zov4ik.display.screens.mainmenu.altscreen;
...
import im.zov4ik.common.animation.implement.InOutBack;
...
public class AltScreen implements QuickImports {
    private final AccountRepository accountRepository = zov4ik.getInstance().getAccountRepository();
