...
import im.zov4ik.features.impl.combat.TriggerBot;
...
import im.zov4ik.utils.math.calc.CalcVector;
...
public class TargetESP extends Module {
    ...
    SelectSetting targetEspType = new SelectSetting("Отображения таргета", "Выбирает тип цели esp")
            .value("Cube", "Circle", "Ghosts", "Crystals", "Crystals2", "Prizraki", "Kolco", "GhostRider", "Nursultan")
            .selected("Circle");
    ...
    public void onWorldRender(WorldRenderEvent e) {
        ...
        if (lastTarget != null && !esp_anim.isFinished(Direction.BACKWARDS)) {
            ...
            switch (targetEspType.getSelected()) {
                ...
                case "Prizraki" -> Render3D.drawGhosts(lastTarget, anim, red, 0.72F);
                case "Kolco" -> Render3D.drawCircle(e.getStack(), lastTarget, anim, red);
                case "GhostRider" -> Render3D.drawGhosts(lastTarget, anim, red, 0.82F);
                case "Nursultan" -> Render3D.drawCube(lastTarget, anim, red, cubeType.getSelected());
                case "Crystals" -> {
