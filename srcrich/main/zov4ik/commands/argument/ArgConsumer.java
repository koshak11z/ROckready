...
package im.zov4ik.commands.argument;
...
import im.zov4ik.utils.client.managers.api.command.datatypes.IDatatype;
import im.zov4ik.utils.client.managers.api.command.datatypes.IDatatypeContext;
import im.zov4ik.utils.client.managers.api.command.datatypes.IDatatypeFor;
import im.zov4ik.utils.client.managers.api.command.datatypes.IDatatypePost;
import im.zov4ik.utils.client.managers.api.command.exception.CommandException;
import im.zov4ik.utils.client.managers.api.command.exception.CommandInvalidTypeException;
import im.zov4ik.utils.client.managers.api.command.exception.CommandNotEnoughArgumentsException;
import im.zov4ik.utils.client.managers.api.command.exception.CommandTooManyArgumentsException;
import im.zov4ik.utils.client.managers.api.command.manager.ICommandManager;
