package im.zov4ik.utils.client.managers.event;

import net.minecraft.text.Text;
import net.minecraft.util.Formatting;
import im.zov4ik.utils.client.managers.event.events.Event;
import im.zov4ik.utils.client.managers.event.events.EventStoppable;
import im.zov4ik.utils.client.managers.event.types.Priority;
import im.zov4ik.common.logger.implement.ConsoleLogger;
import im.zov4ik.common.logger.implement.MinecraftLogger;
