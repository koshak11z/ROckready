...
import im.zov4ik.utils.display.font.entry.DrawEntry;
import im.zov4ik.utils.display.font.glyph.Glyph;
import im.zov4ik.utils.display.font.glyph.GlyphMap;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("zov4ik", "temp/" + StringHelper.randomString(32));
    }
