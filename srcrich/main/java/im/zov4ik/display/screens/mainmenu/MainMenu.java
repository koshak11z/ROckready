package im.zov4ik.display.screens.mainmenu;

import antidaunleak.api.UserProfile;
import im.zov4ik.common.animation.Direction;
import im.zov4ik.display.screens.mainmenu.altscreen.AltScreen;
import im.zov4ik.utils.client.text.TextAnimation;
...
import im.zov4ik.utils.display.gif.GifRender;
...
public class MainMenu extends Screen implements QuickImports {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (mainAlpha > 0.01f) {
            ...
            Fonts.getSize(18, Fonts.Type.DEFAULT).drawCenteredString(context.getMatrices(), "zov4ik Client, you made the right choice.", width / 2, sy - 40, applyAlpha(new Color(200, 200, 200).getRGB(), mainAlphaInt));
            ...
            Fonts.getSize(12, Fonts.Type.DEFAULT).drawCenteredString(context.getMatrices(), "© 2025 zov4ikClient. All rights reserved.", width / 2 + 2, height - 7, applyAlpha(ColorAssist.getText(0.35f), mainAlphaInt));
