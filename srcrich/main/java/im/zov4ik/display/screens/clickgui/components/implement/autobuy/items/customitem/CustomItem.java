package im.zov4ik.display.screens.clickgui.components.implement.autobuy.items.customitem;
...
public class CustomItem implements AutoBuyableItem {
    ...
    public ItemStack createItemStack() {
        ...
        if (material == Items.POTION && potionContents != null) {
            stack.set(DataComponentTypes.POTION_CONTENTS, potionContents);
        } else if (material == Items.POTION) {
            stack.set(DataComponentTypes.POTION_CONTENTS, new PotionContentsComponent(Optional.empty(), Optional.of(0x385DC6), List.<StatusEffectInstance>of(), Optional.empty()));
