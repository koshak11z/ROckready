package im.zov4ik.display.screens.clickgui.components.implement.autobuy.settings;
...
public abstract class AutoBuySettingsComponent extends AbstractComponent {
    ...
    public static class BuyBelowComponent extends AutoBuySettingsComponent {
        ...
        public void render(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            Fonts.getSize(13, Fonts.Type.SEMI).drawString(matrix, "????. ????:", x + 10, y + 10, ColorAssist.getText(0.8f));
...
//    }
    ...
    public static class MinQuantityComponent extends AutoBuySettingsComponent {
        ...
        public void render(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            Fonts.getSize(13, Fonts.Type.SEMI).drawString(matrix, "???. ???-??:", x + 10, y + 8, ColorAssist.getText(0.8f));
