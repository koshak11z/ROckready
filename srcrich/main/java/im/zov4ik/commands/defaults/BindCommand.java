...
import im.zov4ik.utils.client.managers.api.command.datatypes.KeyDataType;
import im.zov4ik.utils.client.managers.api.command.datatypes.ModuleDataType;
...
public class BindCommand extends Command {
    ...
    public BindCommand(zov4ik main) {
        super("bind");
