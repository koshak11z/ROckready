...
public class DonatorProvider {
    public static List<AutoBuyableItem> getDonator() {
        ...
        donator.add(new CustomItem("[★] TNT - TIER WHITE", "Таер вайт", null, Items.TNT, Defaultpricec.getPrice("TNT - TIER WHITE"), null, tntWhiteLore));
        List<Text> tntBlackLore = List.of(
                Text.literal("Этот динамит взрывается"),
                Text.literal("в 10 раз сильнее обычного"),
                Text.literal("и способен взорвать обсидиан")
        );
        donator.add(new CustomItem("[★] TNT - TIER BLACK", "Таер блэк", null, Items.TNT, Defaultpricec.getPrice("TNT - TIER BLACK"), null, tntBlackLore));
        ...
        donator.add(new CustomItem("Прогрузчик чанков [1x1]", "Блок чанкер", null, Items.STRUCTURE_BLOCK, Defaultpricec.getPrice("Прогрузчик чанков [1x1]"), null, chunkLoader1x1Lore));
        ...
        donator.add(new CustomItem("Прогрузчик чанков [3x3]", "Блок чанкер", null, Items.STRUCTURE_BLOCK, Defaultpricec.getPrice("Прогрузчик чанков [3x3]"), null, chunkLoader3x3Lore));
        ...
        donator.add(new CustomItem("Прогрузчик чанков [5x5]", "Блок чанкер", null, Items.STRUCTURE_BLOCK, Defaultpricec.getPrice("Прогрузчик чанков [5x5]"), null, chunkLoader5x5Lore));
