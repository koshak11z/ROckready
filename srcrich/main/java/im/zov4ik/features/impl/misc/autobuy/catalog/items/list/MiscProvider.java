...
import im.zov4ik.features.impl.misc.autobuy.catalog.util.krushprovider.KrushItem;
...
public class MiscProvider {
    public static List<AutoBuyableItem> getMisc() {
        ...
        ItemStack whiteTnt = new ItemStack(Items.TNT);
        whiteTnt.set(DataComponentTypes.CUSTOM_NAME, Text.literal("TNT - TIER WHITE"));
        misc.add(new KrushItem("TNT - TIER WHITE", Items.TNT, whiteTnt, Defaultpricec.getPrice("TNT - TIER WHITE")));
        ItemStack blackTnt = new ItemStack(Items.TNT);
        blackTnt.set(DataComponentTypes.CUSTOM_NAME, Text.literal("TNT - TIER BLACK"));
        misc.add(new KrushItem("TNT - TIER BLACK", Items.TNT, blackTnt, Defaultpricec.getPrice("TNT - TIER BLACK")));
