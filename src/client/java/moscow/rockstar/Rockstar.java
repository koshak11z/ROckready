...
import moscow.rockstar.utility.baritone.BaritoneBootstrap;
...
public enum Rockstar implements IMinecraft
{
    ...
    public void initialize() {
        ...
        ResourceManagerHelper.get((ResourceType)ResourceType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener(){
    ...
    private void createAvatar() {
        try {
            ...
            mc.getTextureManager().registerTexture(id, (AbstractTexture)new NativeImageBackedTexture(WebUtility.bufferedImageToNativeImage(bufferedImage, true)));
        }
