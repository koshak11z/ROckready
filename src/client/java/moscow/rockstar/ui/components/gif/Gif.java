...
implements IMinecraft {
    ...
    public Gif(Identifier gifIdentifier, float x, float y, float width, float height) {
        ...
        this.sharedImage = new NativeImage(NativeImage.Format.RGBA, imgWidth, imgHeight, false);
        ...
        mc.getTextureManager().registerTexture(this.dynamicTextureId, (AbstractTexture)this.dynamicTexture);
