...
extends Rect {
    ...
    public void draw(UIContext context) {
        ...
        context.drawRoundedRect(this.x, this.y, this.width, this.height, BorderRadius.all(Math.min(this.width, this.height) / 2.0f), this.backgroundColor.withAlpha(255.0f * (0.33f * this.activeAnim.getValue() + 0.2f * this.hoverAnim.getValue())));
