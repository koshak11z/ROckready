...
extends MenuSettingComponent<SliderSetting> {
    ...
    protected void renderComponent(UIContext context) {
        ...
        context.drawRoundedRect(x, y + this.height - 12.0f, width, 2.0f, BorderRadius.all(0.25f), Colors.getSliderWindowColor().mulAlpha((255.0f - 100.0f * Interface.glass()) * 0.7f / 255.0f));
        context.drawRoundedRect(x, y + this.height - 12.0f, width * GuiUtility.getPercent(this.animation.getValue(), ((SliderSetting)this.setting).getMin(), ((SliderSetting)this.setting).getMax()), 2.0f, BorderRadius.all(0.25f), Colors.getSliderTrackColor());
        ...
        if (Interface.showGlass()) {
            ...
            context.drawSquircle(x + width * GuiUtility.getPercent(this.animation.getValue(), ((SliderSetting)this.setting).getMin(), ((SliderSetting)this.setting).getMax()) - 4.5f - 3.0f * this.moving.getValue(), y + this.height - 11.0f - 3.0f - 2.0f * this.moving.getValue(), 9.0f + 6.0f * this.moving.getValue(), 6.0f + 4.0f * this.moving.getValue(), 7.0f, BorderRadius.all(3.0f + this.moving.getValue()), Colors.getSliderCircleColor().mulAlpha((1.0f - this.moving.getValue()) * Interface.glass()));
            context.drawLiquidGlass(x + width * GuiUtility.getPercent(this.animation.getValue(), ((SliderSetting)this.setting).getMin(), ((SliderSetting)this.setting).getMax()) - 4.5f - 3.0f * this.moving.getValue(), y + this.height - 11.0f - 3.0f - 2.0f * this.moving.getValue(), 9.0f + 6.0f * this.moving.getValue(), 6.0f + 4.0f * this.moving.getValue(), 7.0f, BorderRadius.all(3.0f + this.moving.getValue()), Colors.getSliderCircleColor().mulAlpha(this.moving.getValue() * Interface.glass()), true);
        }
        if (Interface.showMinimalizm()) {
            ...
            context.drawRoundedRect(x + width * GuiUtility.getPercent(this.animation.getValue(), ((SliderSetting)this.setting).getMin(), ((SliderSetting)this.setting).getMax()) - 3.0f, y + this.height - 14.0f + this.moving.getValue(), 6.0f, 6.0f - this.moving.getValue() * 2.0f, BorderRadius.all(3.0f - this.moving.getValue() * 2.0f), Colors.getSliderCircleColor().mulAlpha(Interface.minimalizm()));
        }
