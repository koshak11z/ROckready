...
extends BaseModule {
    ...
    public boolean shouldPreventInteract(Block block) {
        ...
        if (block instanceof CraftingTableBlock && this.craftingTables.isSelected()) {
            return true;
        }
        if (block instanceof EnchantingTableBlock && this.enchantingTables.isSelected()) {
            return true;
        }
        if (block instanceof BedBlock && this.beds.isSelected()) {
            return true;
        }
        if (block instanceof ChestBlock && this.chests.isSelected()) {
            return true;
        }
        if (block instanceof EnderChestBlock && this.enderChests.isSelected()) {
            return true;
        }
        if (block instanceof TrappedChestBlock && this.trappedChests.isSelected()) {
            return true;
        }
        if (block instanceof AbstractFurnaceBlock && this.furnaces.isSelected()) {
            return true;
        }
        if (block instanceof BarrelBlock && this.barrels.isSelected()) {
            return true;
        }
        if (block instanceof ShulkerBoxBlock && this.shulkers.isSelected()) {
            return true;
        }
        if (block instanceof DropperBlock && this.droppers.isSelected()) {
            return true;
        }
        if (block instanceof DispenserBlock && this.dispensers.isSelected()) {
            return true;
        }
        if (block instanceof HopperBlock && this.hoppers.isSelected()) {
            return true;
        }
        if (block instanceof AnvilBlock && this.anvils.isSelected()) {
            return true;
        }
        if (block instanceof AbstractCauldronBlock && this.cauldrons.isSelected()) {
            return true;
        }
        if (block instanceof AbstractSignBlock && this.signs.isSelected()) {
            return true;
        }
        if (block instanceof BellBlock && this.bells.isSelected()) {
            return true;
        }
        if (block instanceof ComposterBlock && this.composters.isSelected()) {
            return true;
        }
        if (block instanceof BrewingStandBlock && this.brewingStands.isSelected()) {
            return true;
        }
        if (block instanceof JukeboxBlock && this.jukeBoxes.isSelected()) {
            return true;
        }
        if (block instanceof CommandBlock && this.commandBlocks.isSelected()) {
            return true;
        }
        if (block instanceof BeaconBlock && this.beacons.isSelected()) {
            return true;
        }
        if (block instanceof RespawnAnchorBlock && this.respawnAnchors.isSelected()) {
            return true;
        }
        if (block instanceof GrindstoneBlock && this.grindstones.isSelected()) {
            return true;
        }
        if (block instanceof LecternBlock && this.lecterns.isSelected()) {
            return true;
        }
        if (block instanceof CartographyTableBlock && this.cartographyTables.isSelected()) {
            return true;
        }
        if (block instanceof LoomBlock && this.looms.isSelected()) {
            return true;
        }
        if (block instanceof SmithingTableBlock && this.smithingTables.isSelected()) {
            return true;
        }
        return block instanceof StonecutterBlock && this.stonecutters.isSelected();
    }
}
