...
public class FriendCommand {
    ...
    private void printList() {
        ...
        if (friends.isEmpty()) {
            MessageUtility.info(Text.of((String)Localizator.translate("commands.friends.empty")));
            return;
        }
        MessageUtility.info(Text.of((String)Localizator.translate("commands.friends.list")));
        for (int i = 0; i < friends.size(); ++i) {
            MessageUtility.info(Text.of((String)("[" + (i + 1) + "] " + friends.get(i))));
        }
    }
}
