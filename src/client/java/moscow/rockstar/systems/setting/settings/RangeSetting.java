...
extends AbstractSetting {
    ...
    public void setFirstValue(float value) {
        this.firstValue = (float)MathHelper.clamp((double)((double)Math.round((double)value * (1.0 / (double)this.step)) / (1.0 / (double)this.step)), (double)this.min, (double)this.max);
    }

    public void setSecondValue(float value) {
        this.secondValue = (float)MathHelper.clamp((double)((double)Math.round((double)value * (1.0 / (double)this.step)) / (1.0 / (double)this.step)), (double)this.min, (double)this.max);
    }
