...
extends AbstractSetting {
    ...
    public void setCurrentValue(float currentValue) {
        this.currentValue = MathHelper.clamp((float)((float)((double)Math.round((double)currentValue * (1.0 / (double)this.step)) / (1.0 / (double)this.step))), (float)this.min, (float)this.max);
    }
