...
implements IMinecraft {
    ...
    private Vec3d getRenderPos(Vec3d prevPosition, Vec3d position) {
        double x = prevPosition.getX() + (position.getX() - prevPosition.getX()) * (double)CustomParticle.getTickDelta() - CustomParticle.mc.getEntityRenderDispatcher().camera.getPos().getX();
        double y = prevPosition.getY() + (position.getY() - prevPosition.getY()) * (double)CustomParticle.getTickDelta() - CustomParticle.mc.getEntityRenderDispatcher().camera.getPos().getY();
        double z = prevPosition.getZ() + (position.getZ() - prevPosition.getZ()) * (double)CustomParticle.getTickDelta() - CustomParticle.mc.getEntityRenderDispatcher().camera.getPos().getZ();
