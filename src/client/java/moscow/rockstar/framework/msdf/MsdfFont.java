...
public final class MsdfFont {
    ...
    public static class Builder {
        ...
        public Builder data(String dataFileName) {
            this.dataIdentifer = Identifier.of((String)Rockstar.MOD_ID, (String)("fonts/msdf/" + dataFileName + ".json"));
            return this;
        }

        public Builder atlas(String atlasFileName) {
            this.atlasIdentifier = Identifier.of((String)Rockstar.MOD_ID, (String)("fonts/msdf/" + atlasFileName + ".png"));
            return this;
        }
